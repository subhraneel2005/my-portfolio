...
const tech = [
  ...
  { src: "/tech/gemni.png", name: "Gemini" },
  { src: "/tech/google.webp", name: "Google OAuth2" },
  { src: "/tech/jwt.svg", name: "JWT" },
];
...
export default function ProjectCard({
  ...
  return (
    <div className="w-full flex flex-col justify-center items-start border border-dashed p-4 rounded-xl border-[#00A9FF]/40 bg-[#CDF5FD]/5 dark:border-[#00A9FF]/30 dark:bg-[#CDF5FD]/3">
          ...
          <div className="flex gap-4 justify-center items-center">
            {liveUrl && (
              <a
                ...
                className="group relative inline-flex h-7 w-7 items-center justify-center overflow-hidden rounded-md bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 transition-all duration-300 hover:w-24"
              >
      ...
      <div className="flex gap-2 flex-wrap mt-3">
        {techWithImages.map((t, index) => (
          <span
            key={index}
            className="flex justify-center items-center gap-1 border border-dashed px-1 rounded-md border-[#00A9FF]/60 bg-[#CDF5FD]/30 dark:border-[#00A9FF]/40 dark:bg-[#CDF5FD]/10"
          >
            {t.src && (
      ...
      <p className="text-zinc-700 dark:text-zinc-300 text-sm leading-relaxed mt-3">
        {description}
      </p>
    </div>
  );
